...
libmysql/libmysqlclient_r.so: libmysql/libmysqlclient.so
	...
	cd /opt/inception-master/libmysql && /usr/bin/cmake -E remove -f /opt/inception-master/libmysql/libmysqlclient_r.so
	cd /opt/inception-master/libmysql && /usr/bin/cmake -E create_symlink libmysqlclient.so libmysqlclient_r.so
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.dir/clean:
	cd /opt/inception-master/libmysql && $(CMAKE_COMMAND) -P CMakeFiles/symlink_libmysqlclient_r.so.dir/cmake_clean.cmake
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.dir/depend:
	cd /opt/inception-master && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/inception-master /opt/inception-master/libmysql /opt/inception-master /opt/inception-master/libmysql /opt/inception-master/libmysql/CMakeFiles/symlink_libmysqlclient_r.so.dir/DependInfo.cmake --color=$(COLOR)
